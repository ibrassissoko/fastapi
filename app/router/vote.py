...
# Vote Endpoint
#-------------------------------------------------------------------------------
@router.post("/", status_code=status.HTTP_201_CREATED, description="Cast or remove a vote on a post",
             summary="Vote Endpoint", response_description="Vote action result")
